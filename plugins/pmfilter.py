...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @syd_xyz
        ...
        if await db.has_premium_access(user_id):                               
            ...
            buttons = [[
                    InlineKeyboardButton('☒ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴩ ☒', url=f'http://telegram.me/{temp.U_NAME}?startgroup=true')
                ],[
                    InlineKeyboardButton('⌬ ᴇᴀʀɴ ᴍᴏɴᴇʏ ⌬', callback_data="shortlink_info"),
                    InlineKeyboardButton('⚝ ᴜᴩᴅᴀᴛᴇꜱ ⚝', callback_data='channels')
                ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            search = message.text
            m=await message.reply_sticker("CAACAgUAAxkBAAEEntRoNv5RssXq49AfcMw7GzMGyrX4DwAC-hYAAiYKuVVPOB1Mk7GzKB4E",
